...
const product = {
  ...
  images: [
    {
      id: 1,
      imageSrc: 'vista-01.jpg',
      imageAlt: "Sala controlli Telecontrol.",
      primary: true,
    },
  ],
  colors: [
...
const relatedProducts = [
  ...
  },
  {
    ...
    name: 'Basic Tee',
    href: '#',
    imageSrc: 'vista-04-assometria.jpg',
    imageAlt: "Front of men's Basic Tee in white.",
    price: '$35',
    color: 'Aspen White',
  },
  {
    ...
    name: 'Basic Tee',
    href: '#',
    imageSrc: 'pianta-piano-terreno.jpg',
    imageAlt: "Front of men's Basic Tee in white.",
    price: '$35',
    color: 'Aspen White',
  },
