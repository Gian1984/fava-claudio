                  ...
                  <div class="mt-6 grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                    ...
                    <div  class="group relative">
                      <div class="min-h-64 aspect-w-3 aspect-h-2 overflow-hidden bg-gray-200">
                        ...
                        >
                          <img src="img/pubblicazioni/100idee_luglio2022/100idee_luglio2022_1.webp" alt="Il wellness a casa" class="aspect-w-3 aspect-h-2 object-cover  sm:pr-2 lg:pr-12 float-end" />
                        </a>
                      </div>
...
const steps = [
  { name: 'Cose di Casa', href: '/Cose_di_casa', status: 'upcoming' },
  { name: '100 Idee per Restrutturare', href: '/Cento_idee', status: 'current' },
]
